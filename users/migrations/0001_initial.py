    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=30, unique=True, verbose_name='Телефон номер')),
                ('user_type', models.CharField(choices=[('Журналист', 'Журналист'), ('Другое', 'Другое')], default='Журналист', max_length=100, verbose_name='Статус')),
