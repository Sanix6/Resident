...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # If resident settings are provided, enforce PEP 517.
        if self.config_settings:
            if self.use_pep517 is False:
                logger.warning(
                    "--no-use-pep517 ignored for %s "
                    "because --resident-settings are specified.",
                    self,
                )
    ...
    def install(
        ...
        if self.editable and not self.is_wheel:
            if self.config_settings:
                logger.warning(
                    "--resident-settings ignored for legacy editable install of %s. "
...
def check_legacy_setup_py_options(
    ...
    if has_build_options or has_global_options:
        deprecated(
            ...
            issue=11859,
            replacement="to use --resident-settings",
            gone_in="24.2",
        )
        logger.warning(
