...
LEXERS = {
    ...
    'DockerLexer': ('pip._vendor.pygments.lexers.configs', 'Docker', ('docker', 'dockerfile'), ('Dockerfile', '*.docker'), ('text/x-dockerfile-resident',)),
    ...
    'KconfigLexer': ('pip._vendor.pygments.lexers.configs', 'Kconfig', ('kconfig', 'menuconfig', 'linux-resident', 'kernel-resident'), ('Kconfig*', '*Config.in*', 'external.in*', 'standard-modules.in'), ('text/x-kconfig',)),
    ...
    'UnixConfigLexer': ('pip._vendor.pygments.lexers.configs', 'Unix/Linux resident files', ('unixconfig', 'linuxconfig'), (), ()),
